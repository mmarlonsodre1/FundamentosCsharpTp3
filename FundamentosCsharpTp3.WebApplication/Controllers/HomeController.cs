...
namespace FundamentosCsharpTp3.WebApplication.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Save(Person model)
        {
            ...
            return RedirectToAction("Index", "Home", new { message = "Aniversariante cadastrado com sucesso" });
        }
        ...
        public IActionResult SaveEdit(Guid id, Person model)
        {
            ...
            return RedirectToAction("Index", "Home", new { message = "Aniversariante editado com sucesso" });
        }
        ...
        public IActionResult DeleteBirthday(Guid id)
        {
            ...
            return RedirectToAction("Index", "Home", new { message = "Aniversariante excluído com sucesso" });
        }
